INSERT INTO Restposition (id, name, salary)
VALUES (x'fffffffffffffffffffffffffffffffd', 'position1', 2);
INSERT INTO Restposition (id, name, salary)
VALUES (x'ffffffffffffffffffffffffffffffff', 'position2', 10);

INSERT INTO Reststuff (id, surname, name, patronymic, sex, birth_date, salary_multiplier,position_id)
...
INSERT INTO Restoffice (id,name,address, law_address,cabinets_count)
VALUES (x'0000000000000000000000000000000e','name1', 'address1', 'lawAddress1', 101);
INSERT INTO Restoffice (id,name,address, law_address,cabinets_count)
VALUES (x'0000000000000000000000000000000f','name2', 'address2', 'lawAddress2', 11111);

INSERT INTO Restclient (id,surname,name,patronymic,sex,birth_date,inn,passport_serial,phone)
...
INSERT INTO Restoffer (id, serial_numbers, sign_date, ending_date, start_date, stuff_id, client_id, office_id)
